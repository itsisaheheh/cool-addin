...
exports.AppIdNotExist = exports.AppPackageSizeExceededError = exports.InvalidFileOutsideOfTheDirectotryError = exports.CheckSideloadingPermissionFailedError = exports.DeveloperPortalAPIFailedUserError = exports.DeveloperPortalAPIFailedSystemError = void 0;
...
class AppPackageSizeExceededError extends teamsfx_api_1.UserError {
    constructor(actualSizeInBytes, maxSizeInBytes) {
        const actualMB = (actualSizeInBytes / (1024 * 1024)).toFixed(2);
        const maxMB = (maxSizeInBytes / (1024 * 1024)).toFixed(2);
        const errorOptions = {
            source: constants_1.Constants.PLUGIN_NAME,
            message: (0, localizeUtils_1.getDefaultString)("error.teamsApp.createAppPackage.packageSizeExceeded", actualMB, maxMB),
            displayMessage: (0, localizeUtils_1.getLocalizedString)("error.teamsApp.createAppPackage.packageSizeExceeded", actualMB, maxMB),
            categories: [types_1.ErrorCategory.External],
        };
        super(errorOptions);
    }
}
exports.AppPackageSizeExceededError = AppPackageSizeExceededError;
