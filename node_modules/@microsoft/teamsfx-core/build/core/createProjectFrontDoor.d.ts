 ...
 */
export declare function createProjectFrontDoor(inputs: Inputs, deps: CreateFrontDoorDeps): Promise<Result<CreateProjectResult, FxError>>;
//# sourceMappingURL=createProjectFrontDoor.d.ts.map