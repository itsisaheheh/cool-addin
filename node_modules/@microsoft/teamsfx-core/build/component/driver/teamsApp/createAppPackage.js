...
let CreateAppPackageDriver = CreateAppPackageDriver_1 = class CreateAppPackageDriver {
    description = (0, localizeUtils_1.getLocalizedString)("driver.teamsApp.description.createAppPackageDriver");
    progressTitle = (0, localizeUtils_1.getLocalizedString)("plugins.appstudio.createPackage.progressBar.message");
    ...
    async build(args, context) {
        ...
        if (manifestVersion && semver_1.default.gte(manifestVersion, "1.5.0")) {
            additionalLanguages = manifest.localizationInfo
                ?.additionalLanguages;
        }
...
exports.CreateAppPackageDriver = CreateAppPackageDriver = CreateAppPackageDriver_1 = tslib_1.__decorate([
