...
export declare const officeAddinGeneratorDeps: {
    convertProject: typeof officeAddinProject.convertProject;
};
/**
...
export declare class OfficeAddinGenerator {
     ...
     */
    static ensurePackageJsonForConvert(addinRoot: string): Promise<void>;
}
type OfficeHost = "Outlook" | "Word" | "Excel" | "PowerPoint";
