                ...
                if (ymlPath) {
                    ...
                    if (injectResult.wellKnownUrlPlaceholderUsed) {
                        warnings.push({
                            ...
                            content: (0, localizeUtils_1.getLocalizedString)("core.MCPForDA.mcpAuthDcrPlaceholderWarning", mcpServerUrl),
                        });
                    }
                }
            }
