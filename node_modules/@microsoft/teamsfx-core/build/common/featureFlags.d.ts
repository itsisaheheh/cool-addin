...
export declare class FeatureFlagManager {
    ...
    getBooleanValueByName(featureFlagName: string, defaultValue?: boolean): boolean;
...
export declare function readBooleanFeatureFlag(featureFlagName: string, defaultValue?: boolean): boolean;
