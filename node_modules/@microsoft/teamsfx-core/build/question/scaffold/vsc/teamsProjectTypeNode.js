 ...
 */
function getTeamsProjectNode() {
    const root = (0, rootNode_1.getRootProjectTypeNode)(teamsfx_api_1.Platform.VSCode);
    const teamsNode = root.children?.find((c) => c.condition?.equals === "teams-agent-and-app-type");
...
function customCopilotRagNode() {
    return {
        ...
        children: [(0, commonNodes_1.apiSpecNode)({ equals: CapabilityOptions_1.CustomCopilotRagOptions.customApi().id })],
    };
}
...
function botProjectTypeNode() {
    return {
        ...
        data: {
            ...
            placeholder: (0, localizeUtils_1.getLocalizedString)("template.createCapabilityQuestion.placeholder"),
            onDidSelection: CapabilityOptions_1.setTemplateName,
        },
...
function m365SearchMeSubNode() {
    return {
        ...
        data: {
            ...
            placeholder: (0, localizeUtils_1.getLocalizedString)("template.createProjectQuestion.projectType.copilotExtension.placeholder"),
        ...
        children: [
            ...
            (0, commonNodes_1.apiSpecNode)({ equals: CapabilityOptions_1.MeArchitectureOptions.openApiSpec().id }),
        ],
    };
}
function MCPServerTypeNode() {
    return {
        condition: { equals: CapabilityOptions_1.ActionStartOptions.mcp().id },
        data: {
            name: questionNames_1.QuestionNames.MCPServerType,
            title: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.mcpServerType.title"),
            type: "singleSelect",
            staticOptions: [],
            dynamicOptions: async (inputs) => {
                ...
                const options = [
                    {
                        id: "remote",
                        label: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.mcpServerType.remote.label"),
                        detail: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.mcpServerType.remote.detail"),
                    },
                ];
                if (servers.length > 0) {
                    options.push({
                        id: "local",
                        label: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.mcpServerType.local.label"),
                        detail: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.mcpServerType.local.detail"),
                    });
                }
                return options;
            },
            default: "remote",
            placeholder: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.mcpServerType.placeholder"),
            skipSingleOption: true,
        },
        children: [
            {
...
function MCPLocalServerSelectionNode() {
    return {
        ...
        data: {
            name: questionNames_1.QuestionNames.MCPLocalServer,
            title: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.mcpLocalServer.title"),
            type: "multiSelect",
            returnObject: true,
            staticOptions: [],
            placeholder: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.mcpLocalServer.placeholder"),
            dynamicOptions: (inputs) => {
                const servers = inputs["_McpOdrOutput"];
            ...
            validationHelp: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.mcpLocalServer.validationHelp"),
        },
        children: [],
    };
}
...
function MCPForDAServerUrlNode() {
    return {
        condition: { equals: CapabilityOptions_1.ActionStartOptions.mcp().id },
        data: {
            name: questionNames_1.QuestionNames.MCPForDAServerUrl,
...
function updateActionWithMCP() {
    return {
        ...
        children: [
            ...
            {
                condition: (inputs) => {
                    return inputs[questionNames_1.QuestionNames.MCPForDAAuth] !== "NoneAuth";
                },
                data: {
                    type: "singleSelect",
                    name: questionNames_1.QuestionNames.MCPForDAAuthType,
