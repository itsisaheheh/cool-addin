...
export declare class MeCapabilityOptions {
...
export declare class OfficeAddinCapabilityOptions {
...
export declare class BotCapabilityOptions {
...
export declare class NotificationBotOptions {
...
export declare class DACapabilityOptions {
...
export declare class ActionStartOptions {
    static newApi(): OptionItem;
...
export declare class ApiAuthOptions {
    static none(isME?: boolean): OptionItem;
    static apiKey(): OptionItem;
    static bearerToken(): OptionItem;
    static microsoftEntra(isME?: boolean): OptionItem;
    static oauth(): OptionItem;
}
export declare function setTemplateName(selected: string | OptionItem, inputs: Inputs): void;
export declare function setTemplateNameAndGC(selected: string | OptionItem, inputs: Inputs): void;
//# sourceMappingURL=CapabilityOptions.d.ts.map