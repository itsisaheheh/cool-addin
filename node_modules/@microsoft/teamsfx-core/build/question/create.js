...
exports.selectTabsContentUrlQuestion = exports.createQuestionDeps = exports.listOperations = exports.createContext = void 0;
...
exports.apiSpecUrlQuestion = apiSpecUrlQuestion;
exports.apiSpecFileQuestion = apiSpecFileQuestion;
...
exports.createContext = globalVars_1.createContext;
exports.listOperations = helper_2.listOperations;
exports.createQuestionDeps = {
    createContext: exports.createContext,
    listOperations: exports.listOperations,
};
            ...
            validFunc: async (input, previousInputs) => {
                ...
                if (previousInputs &&
                    ((previousInputs.stage === teamsfx_api_1.Stage.addWebpart &&
                        ...
                        (previousInputs?.stage === teamsfx_api_1.Stage.addFeature && previousInputs?.projectPath))) {
    ...
    const question = {
        ...
        default: async (inputs) => {
            ...
            if (inputs.teamsAppFromTdp?.appName) {
                defaultName = (0, stringUtils_1.convertToAlphanumericOnly)(inputs.teamsAppFromTdp?.appName);
            }
        ...
        validation: {
            validFunc: async (input, previousInputs) => {
                ...
                if (input.length === 25) {
                    ...
                    const context = exports.createQuestionDeps.createContext();
...
function apiSpecTypeSelectQuestion() {
    return {
        ...
        staticOptions: [
            {
                id: "enter-url",
                label: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.capability.selectOpenAPISpecFromUrl.label"),
            },
            {
                id: "open-file",
                label: (0, localizeUtils_1.getLocalizedString)("core.createProjectQuestion.capability.selectOpenAPISpecFromFile.label"),
            },
            {
                id: "search-api",
...
function apiSpecLocationQuestion(includeExistingAPIs = true) {
    ...
    const validationOnAccept = async (input, inputs) => {
        try {
            ...
            const context = exports.createQuestionDeps.createContext();
            const res = await exports.createQuestionDeps.listOperations(context, input.trim(), inputs, includeExistingAPIs, false, inputs.platform === teamsfx_api_1.Platform.VSCode ? correlationId : undefined);
            if (res.isOk()) {
...
function apiSpecUrlQuestion() {
    ...
    return {
        ...
        validation: {
            validFunc: (input, inputs) => {
                return (0, stringUtils_1.isValidHttpUrl)(input.trim())
                    ? undefined
                    : inputs?.platform === teamsfx_api_1.Platform.CLI
        ...
        additionalValidationOnAccept: {
            validFunc: async (input, inputs) => {
                ...
                const context = exports.createQuestionDeps.createContext();
                const res = await exports.createQuestionDeps.listOperations(context, input.trim(), inputs, true, false, inputs.platform === teamsfx_api_1.Platform.VSCode ? correlationId : undefined);
                if (res.isOk()) {
                    inputs.supportedApisFromApiSpec = res.value;
                }
                else {
    ...
    return {
        ...
        validation: {
            validFunc: async (input, inputs) => {
                ...
                if (!(await fs_extra_1.default.pathExists(input.trim()))) {
    ...
    return {
        ...
        dynamicOptions: async (inputs) => {
            if (inputs[constants_3.QuestionNames.SelectOpenApiSpec]) {
                ...
                const res = await exports.createQuestionDeps.listOperations(context, specUrl, inputs, true, false);
                if (res.isOk()) {
                    inputs.supportedApisFromApiSpec = res.value;
                }
                else {
    ...
    return {
        ...
        title: (inputs) => {
            return inputs[constants_3.QuestionNames.Capabilities] === CapabilityOptions_1.DACapabilityOptions.declarativeAgent().id ||
                ...
                : (0, localizeUtils_1.getLocalizedString)("template.createProjectQuestion.createApiPlugin.title");
        },
        placeholder: (inputs) => {
            return inputs[constants_3.QuestionNames.Capabilities] === CapabilityOptions_1.DACapabilityOptions.declarativeAgent().id ||
                doesProjectExists
                ? (0, localizeUtils_1.getLocalizedString)("template.createProjectQuestion.addApiPlugin.placeholder")
                : (0, localizeUtils_1.getLocalizedString)("template.createProjectQuestion.projectType.copilotExtension.placeholder");
        },
...
function selectExistingPluginManifestQuestion() {
    return {
        ...
        dynamicOptions: async (inputs) => {
            ...
            const declarativeAgentPathRelativePath = manifest?.copilotAgents?.declarativeAgents?.[0]?.file;
