...
import { SelectorSpec } from "./resolveBuildTarget";
/** `UserError` name for malformed selector JSON. */
export declare const BUILD_TARGET_MALFORMED_SELECTOR = "BuildTargetMalformedSelector";
/** Parse raw `selector.json` into a routing-only `SelectorSpec`. */
export declare function parseSelectorSpec(raw: unknown): Result<SelectorSpec, FxError>;
...
export declare function parseSelectorPresentation(raw: unknown): Result<SelectorPresentation, FxError>;
//# sourceMappingURL=parseSelector.d.ts.map