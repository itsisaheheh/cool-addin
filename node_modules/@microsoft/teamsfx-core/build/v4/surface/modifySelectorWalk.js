...
exports.runModifySelector = runModifySelector;
...
function toFxError(e) {
    ...
    return new teamsfx_api_1.SystemError({ source: SOURCE, name: "ModifySelectorWalkFailed", message });
}
function buildPort(floorBytes, presentation, ui, surface, flagReader, v4Registry) {
    ...
    const byName = new Map(presentation.questions.map((question) => [question.name, question]));
...
async function runModifySelector(floorBytes, ui, surface, deps = {}) {
    ...
    const spec = selectorBytesKind === "json"
        ? (0, createSelector_1.openSelectorFromJsonBytes)(floorBytes, "modify")
        : (0, createSelector_1.openModifySelector)(floorBytes);
    if (spec.isErr()) {
        return (0, neverthrow_1.err)(spec.error);
    }
    const presentation = selectorBytesKind === "json"
        ? (0, createSelector_1.openSelectorPresentationFromJsonBytes)(floorBytes, "modify")
        : (0, createSelector_1.openModifySelectorPresentation)(floorBytes);
...
//# sourceMappingURL=modifySelectorWalk.js.map