...
import { BuildTarget } from "../buildTarget/resolveBuildTarget";
...
export declare function runCreateSelector(floorBytes: Buffer, ui: UserInteraction, surface: string, deps?: CreateSelectorDeps): Promise<Result<BuildTarget, FxError>>;
