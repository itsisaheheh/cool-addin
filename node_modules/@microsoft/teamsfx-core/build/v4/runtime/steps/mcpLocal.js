...
exports.mcpLocalMaterializeServers = exports.STEP_MATERIALIZE_LOCAL_SERVERS = exports.mcpLocalDeps = void 0;
...
exports.mcpLocalMaterializeServers = {
    ...
    async apply(resolved, ctx) {
        ...
        if (catalogRaw === undefined) {
            parsed = catalogFromServers(await exports.mcpLocalDeps.listServers());
        }
        else {
            try {
