...
async function scaffold(request, runtime) {
    ...
    if (replaceMap.isErr()) {
        return (0, neverthrow_1.err)(replaceMap.error);
    }
    ...
    const declaredKeys = (0, packageParse_1.parseDeclaredKeys)(request.descriptor);
    ...
    const selectedContent = (0, selectLanguageContent_1.selectLanguageContent)(request.descriptor, request.content, language);
